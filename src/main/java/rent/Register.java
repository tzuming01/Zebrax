...
public class Register extends javax.swing.JFrame {
    ...
    private void btnregisterActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        if (email.length()==0 || password.length()==0 || firstname.length()==0 || lastname.length()==0 || mobilenumber.length()==0 || icnumber.length()==0 || licensenumber.length()==0) {
            JOptionPane.showMessageDialog(this, "All are mandatory field, cannot be empty"); 
        } else {
            User user = new User();
            user.setUser(email, firstname, lastname, mobilenumber, icnumber, licensenumber, password);
